...
export const LogoNavbar = <Link className="link1" to="/"><img className="logo-text" src={process.env.PUBLIC_URL + "/images/logotext.png"} alt="logo-text" /></Link>;
        ...
        <nav className="container-nav" id="container_nav">
            <div className="container h-100">
                ...
                <ul className={menu ? "navbar-list nl-close" : "navbar-list"}>
                    ...
                    <li>
                        <a class="dropdown-toggle link" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Akun Saya
                        </a>
